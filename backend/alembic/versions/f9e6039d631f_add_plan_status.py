...
Revision ID: f9e6039d631f
Revises: a4b5c6d7e8f9
Create Date: 2026-09-04

Renamed from the original "b1c2d3e4f5a6" on 2026-09-06 — that id collided
with the pre-existing b1c2d3e4f5a6_add_org_catalog_grants.py, which would
make Alembic refuse to load the versions directory at all (duplicate
revision id) the next time `alembic upgrade head` runs (see Dockerfile
CMD). Only the id changed; the migration's behavior is unchanged.
"""
