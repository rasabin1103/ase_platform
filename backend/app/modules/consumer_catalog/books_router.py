"""Consumer book endpoints — alias over consumer catalog filtered to type=book."""
...
def list_books(
    ...
    return svc.list_items(
        ...
        limit=limit,
        offset=offset,
        type_filter=CatalogItemType.book,
        category=category,
        search=search,
...
def get_book(
    ...
    item = svc.get_by_slug(slug, user_id=user.id, allow_preview=allow_preview)
