  ...
  return (
    <div className="min-h-screen bg-ase-bg">
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:items-start lg:gap-16">
            <div className="lg:col-span-6">
              ...
              <div className="mt-10 grid max-w-xl grid-cols-3 gap-4 border-t border-white/10 pt-8">
                ...
                <div>
                  <div className="text-label text-ase-muted">PROYECTOS</div>
                  <div className="mt-2 font-mono text-data-lg text-ase-text">
                    <CountUpInView value={120} />+
                  </div>
                </div>
                <div>
                  <div className="text-label text-ase-muted">DISCIPLINAS</div>
                  <div className="mt-2 font-mono text-data-lg text-ase-text">
                    <CountUpInView value={6} />
                  </div>
                </div>
              </div>
            </div>
                ...
                {HERO_CARDS.map((id) => (
                  <div key={id}>
                    <Card
                      interactive
                      className={cn(
                        'group relative overflow-hidden rounded-3xl border-white/[0.10] bg-ase-surface p-6 shadow-soft',
                      )}
                    >
                      <div className="relative z-[1] flex items-start gap-3">
                        <span className="flex h-11 w-11 items-center justify-center rounded-2xl border border-white/10 bg-ase-bg2 text-sm text-ase-text">
      ...
      <section className="relative border-t border-white/[0.06] py-16 sm:py-24 lg:py-32">
        ...
        <div className="relative mx-auto w-full max-w-[min(100%,1440px)] px-5 sm:px-8 lg:px-12">
          <div className="grid gap-10 lg:grid-cols-12 lg:items-start lg:gap-12">
            <div className="lg:col-span-6">
              <Eyebrow>{t('aboutPage.why.badge')}</Eyebrow>
            ...
            <div className="lg:col-span-6">
              <div className="relative overflow-hidden rounded-[2rem] border border-white/[0.08] bg-ase-surface p-6 shadow-soft sm:p-8">
                  ...
                  <div className="mt-6 space-y-5">
                    {whyTimeline.map((it, i) => (
                      <div key={`sig-${i}`} className="relative pl-8">
                        <div className="absolute left-2 top-0 bottom-0 w-px bg-ase-border/70" />
                        <div className="absolute left-0 top-1.5 h-4 w-4 rounded-full border border-white/10 bg-ase-bg2 ring-1 ring-ase-brand/20" />
      ...
      <section className="relative border-t border-white/[0.06] py-16 sm:py-24 lg:py-32">
        <BlueprintDivider />
        <div className="relative mx-auto w-full max-w-[min(100%,1440px)] px-5 sm:px-8 lg:px-12">
          <h2 className="max-w-3xl text-3xl font-extrabold tracking-tight text-ase-text sm:text-4xl">
            {t('aboutPage.impact.title')}
          </h2>
          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
            {(['m1', 'm2', 'm3'] as const).map((id) => (
              <ImpactMetricCard key={id} id={id} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="relative border-t border-white/[0.06] py-16 sm:py-24 lg:py-32">
        ...
        <div className="relative mx-auto w-full max-w-[min(100%,1440px)] px-5 sm:px-8 lg:px-12">
          <div className="max-w-3xl">
            <Eyebrow>{t('aboutPage.principles.badge')}</Eyebrow>
          </div>
      ...
      <section className="relative border-t border-white/[0.06] py-16 sm:py-24 lg:py-32">
        ...
        <div className="relative mx-auto w-full max-w-[min(100%,1440px)] px-5 sm:px-8 lg:px-12">
          <div className="max-w-3xl">
            <Eyebrow>{t('aboutPage.build.badge')}</Eyebrow>
      ...
      <section className="relative border-t border-white/[0.06] py-16 sm:py-24 lg:py-32">
        ...
        <div className="relative mx-auto w-full max-w-[min(100%,1440px)] px-5 sm:px-8 lg:px-12">
          <div className="max-w-3xl">
            <Eyebrow>{t('aboutPage.differentiators.badge')}</Eyebrow>
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {differentiators.map((it, i) => (
              <div
                key={`diff-${i}`}
                className="rounded-2xl border border-white/[0.08] bg-ase-surface px-5 py-4 text-sm text-ase-text2 shadow-soft"
              >
      ...
      <section className="relative border-t border-white/[0.06] py-16 sm:py-24 lg:py-32">
        ...
        <div className="relative mx-auto w-full max-w-[min(100%,1440px)] px-5 sm:px-8 lg:px-12">
          <div className="max-w-3xl">
            <Eyebrow>{t('aboutPage.history.badge')}</Eyebrow>
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-ase-text sm:text-4xl">
...
function ImpactMetricCard({ id }: { id: 'm1' | 'm2' | 'm3' }) {
  const { t } = useI18n()
  return (
    <div className="rounded-2xl border border-white/[0.08] bg-ase-bg2/35 p-4 sm:p-5">
      <div className="font-mono text-2xl font-extrabold tracking-tight text-ase-text sm:text-3xl">
        {t(`aboutPage.impact.items.${id}.value`)}
      </div>
      <div className="mt-2 text-sm font-semibold leading-snug text-ase-text">{t(`aboutPage.impact.items.${id}.label`)}</div>
      <div className="mt-1 text-xs text-ase-text2">{t(`aboutPage.impact.items.${id}.sub`)}</div>
    </div>
  )
}
...
function BuildBlock({ id, className }: { id: 'architecture' | 'automation' | 'product' | 'ux'; className?: string }) {
  ...
  return (
    <Card
      interactive
      className={cn(
        'group relative overflow-hidden rounded-3xl border-white/[0.10] bg-ase-surface p-7 shadow-soft',
        className,
      )}
    >
      <div className="flex items-start gap-3">
