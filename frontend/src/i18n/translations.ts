...
export const translations = {
  en: {
    ...
    pricing: {
      ...
      subtitle: 'Switch between monthly or annual billing. Save 10% with annual plans.',
      monthly: 'Monthly',
      yearly: 'Annual',
      save: 'Save 10%',
      annualBadge: 'Save 10%',
      billingToggle: 'Billing period',
      annualHint: 'Annual billing saves 10%',
      mostPopular: 'Most Popular',
      saveTen: 'Save 10%',
      saveAmount: 'Save {amount}',
      monthlyEquivalent: '{price}/month equivalent',
      trialFooter: '14-day free trial. No credit card required.',
      trialDays: '{days}-day free trial included',
      perMonth: '/month',
      perYear: '/year',
    ...
    pages: {
      ...
      contact: {
        badge: 'Contact',
        title: 'Contact Arce Sabin Engineering',
        body:
          'Tell us what you are building, improving or automating. We will review your message and get back to you as soon as possible.',
        corporateEmail: 'Corporate inbox:',
        submit: 'Send message',
        submitting: 'Sending...',
        ...
        fields: {
          ...
          inquiryTypePlaceholder: 'Select an option (optional)',
          subject: 'Subject',
          message: 'Message',
          namePh: 'Your full name',
          companyPh: 'Company or team (optional)',
          messagePh: 'What are you building, improving or automating?',
        },
        inquiryTypes: {
        ...
        responseBody: 'Typical response within 1–2 business days',
      },
      services: {
        badge: 'Services',
  ...
  es: {
    ...
    pricing: {
      ...
      subtitle: 'Elige facturación mensual o anual. Ahorra un 10% con planes anuales.',
      monthly: 'Mensual',
      yearly: 'Anual',
      save: 'Ahorra 10%',
      annualBadge: 'Ahorra 10%',
      billingToggle: 'Periodo de facturación',
      annualHint: 'La facturación anual ahorra un 10%',
      mostPopular: 'Más popular',
      saveTen: 'Ahorra 10%',
      saveAmount: 'Ahorra {amount}',
      monthlyEquivalent: 'Equivalente a {price}/mes',
      trialFooter: 'Prueba gratuita de 14 días. Sin tarjeta de crédito.',
      trialDays: 'Incluye {days} días de prueba',
      perMonth: '/mes',
      perYear: '/año',
    ...
    pages: {
      ...
      contact: {
        badge: 'Contacto',
        title: 'Contacta con Arce Sabin Engineering',
        body:
          'Cuéntanos qué estás construyendo, mejorando o automatizando. Revisaremos tu mensaje y te responderemos lo antes posible.',
        corporateEmail: 'Buzón corporativo:',
        ...
        fields: {
          ...
          inquiryTypePlaceholder: 'Selecciona una opción (opcional)',
          subject: 'Asunto',
          message: 'Mensaje',
          namePh: 'Tu nombre completo',
          companyPh: 'Empresa o equipo (opcional)',
          messagePh: '¿Qué estás construyendo, mejorando o automatizando?',
        },
        inquiryTypes: {
          tech_consulting: 'Consultoría tecnológica',
          qa_automation: 'Automatización QA',
          software_architecture: 'Arquitectura software',
          technical_training: 'Formación técnica',
          saas_platform: 'SaaS / plataforma',
          books_content: 'Libros y contenidos',
          other: 'Otra consulta',
        },
        validation: {
          ...
          messageMax: 'El mensaje es demasiado largo (máx. 5000 caracteres)',
        },
        responseBody: 'Respuesta habitual en 1–2 días laborables',
      },
      services: {
        badge: 'Servicios',
