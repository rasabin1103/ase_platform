...
export const plansPageEn = {
  ...
  create: {
    ...
    helpers: {
      ...
      comingSoonHint: 'Shown on the public pricing page with a "Coming soon" badge, but visitors cannot check out or subscribe yet.',
    },
    button: 'Create plan',
    creating: 'Creating…',
...
export const plansPageEs = {
  ...
  create: {
    ...
    helpers: {
      ...
      comingSoonHint: 'Se muestra en la página pública de precios con una etiqueta "Próximamente", pero los visitantes todavía no pueden comprarlo ni suscribirse.',
    },
    button: 'Crear plan',
    creating: 'Creando…',
