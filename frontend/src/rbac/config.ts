...
export const ROLE_NAV_ROUTES: Record<PlatformRole, string[]> = {
  ...
  org_owner: ['/dashboard', '/organization/catalog', '/organization/grant', '/users', '/requests', '/profile'],
  org_admin: ['/dashboard', '/organization/catalog', '/organization/grant', '/users', '/requests', '/profile'],
  independent_user: [
    '/dashboard',
    '/catalog/products',
    '/catalog/courses',
