    ...
    <section className="relative border-t border-white/[0.06] py-16 sm:py-24 lg:py-32">
      ...
      <div className="relative mx-auto w-full max-w-[min(100%,1440px)] px-5 sm:px-8 lg:px-12">
        <div className="max-w-3xl">
          <Eyebrow>{t('platformPage.dashboard.badge')}</Eyebrow>
        ...
        <div className="mt-12 overflow-hidden rounded-[2rem] border border-white/[0.08] bg-ase-surface p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_22px_70px_rgba(0,0,0,0.55)] sm:p-8">
